...
const gchar *const *cdk_plugin_get_cflags (CdkPlugin *self, gsize *n_cflags);
const gchar *const *cdk_plugin_get_files (CdkPlugin *self, gsize *n_files);
void cdk_plugin_set_cflags (CdkPlugin *self, const gchar *const *cflags, gssize n_cflags);
